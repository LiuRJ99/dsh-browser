...
Write-Host ''
Write-Pair "如果用得顺手，欢迎在 GitHub 点个 Star 支持我们：https://github.com/LiuRJ99/dsh-browser" "If dsh-browser is useful to you, we'd appreciate a Star on GitHub: https://github.com/LiuRJ99/dsh-browser"
